      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16 sm:h-20">
          <div className="flex items-center group cursor-pointer" onClick={() => handleViewChange('table')}>
            ...
            <h1 className="text-sm sm:text-lg md:text-2xl font-black text-gray-900 ml-3 whitespace-nowrap tracking-tighter uppercase">Tabela Táxi <span className="text-yellow-600">Coopervip</span></h1>
          </div>
